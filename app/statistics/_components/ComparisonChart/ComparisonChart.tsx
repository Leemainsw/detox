...
export default function ComparisonChart({ userName, userAmount, compareName, compareAmount }: ChartProps) {
  const chartData = [
  ...
  return (
    <div className="mx-6 py-6 bg-gray-50 rounded-3xl h-[184px]">
